...
## Инициализация 'Харасуга'

1) создать БД с именем 'Laravel'

2) подключится к БД:

- в файле .env задать настройки подключения

2) создать пользователя для админки:

- php artisan adfm:user test test@test.ru test

3) применить миграции и сидеры
