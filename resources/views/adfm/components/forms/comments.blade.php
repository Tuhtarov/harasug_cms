<form class="control-form" method="POST" action="#">
    <div class="control-column">
        ...
        <input name="comment[phone]" class="control-field" required placeholder="Телефон"
               type="tel"  aria-label="Поле для ввода номера телефона">
        <input name="comment[email]" class="control-field" required placeholder="E-mail"
               type="email" aria-label="Поле для ввода электронной почты">
    </div>
    <div class="control-column">
        <textarea name="comment[comment]" class="control-textarea" placeholder="Отзыв" rows="6" cols="12" required></textarea>
    </div>
